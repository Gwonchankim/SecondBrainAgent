...
export function buildIngestInstruction(input: IngestInstructionInput): string {
  ...
  return [
    ...
    "",
    "IMPORTANT: write the created and updated values as QUOTED strings, e.g.",
    '  created: "2026-06-21"',
    "Unquoted dates are parsed by YAML as date objects and will FAIL validation;",
    "the schema requires plain strings.",
    "",
    "## Body",
